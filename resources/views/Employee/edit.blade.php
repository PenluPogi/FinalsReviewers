                        ...
                        <form action="{{ route('employee.edit',$employee->id) }}" method="POST">
                            ...
                            <div class="card-body row g-3">
                                <div class="form-group col-md-6 form-animate">
                                    ...
                                    <input type="text" class="form-control" name="fname" value="{{ $employee->fname}}" placeholder="Enter first name">
                                    @error('fname') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>

                                <div class="form-group col-md-6 form-animate">
                                    <label for="lname">Last Name</label>
                                    <input type="text" class="form-control" name="lname" value="{{ $employee->lname}}"  placeholder="Enter last name">
                                    @error('lname') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>

                                <div class="form-group col-md-6 form-animate">
                                    <label for="midname">Middle Name</label>
                                    <input type="text" class="form-control" name="midname" value="{{ $employee->midname}}" placeholder="Enter middle name">
                                ...
                                <div class="form-group col-md-6 form-animate">
                                    ...
                                    <input type="number" class="form-control" name="age" value="{{ $employee->age}}" placeholder="Enter age">
                                    @error('age') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>

                                <div class="form-group col-md-6 form-animate">
                                    <label for="zip">Zip</label>
                                    <input type="number" class="form-control" name="zip" value="{{ $employee->zip}}" placeholder="Enter ZIP code">
